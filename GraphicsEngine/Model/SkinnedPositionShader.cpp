...
namespace SeedCore
{
	void SkinnedPositionShader::Create(ShaderCache& shaderCache, ID3D12Device* device)
	{
		...
		Handle<ComputeShader> shader = shaderCache.GetOrCreateComputeShader(String("../GraphicsEngine/Model/SkinnedPositionCS.hlsl"));
	...
	ID3D12RootSignature* SkinnedPositionShader::GetRootSignature()const
	{
		return rootSignature_.Get();
	}

	ID3D12PipelineState* SkinnedPositionShader::GetPipelineState()const
	{
