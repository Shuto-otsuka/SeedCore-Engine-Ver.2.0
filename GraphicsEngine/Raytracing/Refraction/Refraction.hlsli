...
// Model/Opaque/DeferredLightingPS.hlsl via structured_indices.refraction_.ray_constant_index_.
...
struct RefractionRayConstantBuffer
{
	...
	// Overall refraction intensity applied in Model/Opaque/DeferredLightingPS.hlsl.
	float strength_;
